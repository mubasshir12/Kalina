...
const ApiKeyModal: React.FC<ApiKeyModalProps> = ({ onSetApiKey }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-50 dark:bg-[#131314] flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-md bg-white dark:bg-[#1e1f22] rounded-2xl shadow-xl p-8 space-y-6">
        <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Enter Your API Key</h1>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                To use Kalina AI, please provide your Google Gemini API key. It will be stored in your browser's session storage.
            </p>
        </div>
